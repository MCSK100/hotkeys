...
const modes = [
  { id: '00', mins: 0, kind: 'quick' as const, name: 'QUICK TEST', desc: 'Short solo sprint. One passage, finish as fast as you can — perfect warm-up.', tag: 'SOLO // QUICK', img: 'https://images.unsplash.com/photo-1552519507-da3b142c6e3d?w=1200&q=70&auto=format&fit=crop' },
  { id: '01', mins: 3, kind: 'solo' as const, name: '3 MIN SPRINT', desc: 'Quick solo burst. Warm up your fingers and lock a clean rhythm before the real battle.', tag: 'SOLO // SHORT', img: 'https://images.unsplash.com/photo-1503376780353-7e6692767b70?w=1200&q=70&auto=format&fit=crop' },
  { id: '02', mins: 5, kind: 'solo' as const, name: '5 MIN CIRCUIT', desc: 'The classic training lap. Hold speed and accuracy for five full minutes of pressure.', tag: 'SOLO // CLASSIC', img: 'https://images.unsplash.com/photo-1542362567-b07e54358753?w=1200&q=70&auto=format&fit=crop' },
  { id: '03', mins: 10, kind: 'solo' as const, name: '10 MIN ENDURANCE', desc: 'Long-haul focus run. Build stamina and chase your best average WPM.', tag: 'SOLO // PRO', img: 'https://images.unsplash.com/photo-1493238792000-8113da705763?w=1200&q=70&auto=format&fit=crop' },
  { id: '04', mins: 0, kind: 'multi' as const, name: 'MULTIPLAYER RACE', desc: 'Create a room, invite friends with a link, pick your car and race the same passage live.', tag: 'VS // LIVE', img: 'https://images.unsplash.com/photo-1511919884226-fd3cad34687c?w=1200&q=70&auto=format&fit=crop' },
];
    ...
    <section id="modes" className="bg-carbon py-16 md:py-24">
      <div className="mx-auto max-w-[1440px] px-5 md:px-10">
        <div className="flex flex-wrap items-end justify-between gap-4">
          ...
          <p className="max-w-xs text-sm leading-6 text-white/55">Solo practice is just you and the clock — no bots. Quick test, or 1, 3, 5, 10 minute typing sprints.</p>
        </div>
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          {m.kind === 'multi' ? (
            ...
            <Link href="/race?mode=practice&duration=0" className="btn-race btn-primary" data-cursor="ENTER">
              START QUICK TEST <span className="arr">→</span>
            </Link>
          ) : (
